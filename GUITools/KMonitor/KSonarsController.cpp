    ...
    ui(new Ui::KSonarsController)
{
	...
	connect(this, SIGNAL(NewHostAdded(QString, QString)),availableSonarsHosts, SLOT(addComboBoxItem(QString, QString)));
	connect(this, SIGNAL(OldHostRemoved(QString)), availableSonarsHosts, SLOT(removeComboBoxItem(QString)));
	connect(this, SIGNAL(GameStateMsgUpdate(QString, QString, QString)), availableSonarsHosts, SLOT(setLWRHGameStateInfo(QString, QString, QString)));

	connect(availableSonarsHosts, SIGNAL(LWRHSubscriptionRequest(QString)), this, SLOT(SubscriptionHandler(QString)));
	connect(availableSonarsHosts, SIGNAL(LWRHUnsubscriptionRequest(QString)), this, SLOT(UnsubscriptionHandler(QString)));
...
void KSonarsController::setLWRHGameStateInfo(QString data1, QString data2, QString data3){
...
void KSonarsController::UnsubscriptionHandler(QString data1){
	un_checkAllTreeElements(Qt::Unchecked);
	mapArea->resetKMapScene();
