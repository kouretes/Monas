    ...
    ui(new Ui::CommandsController)
{
	...
	connect(this, SIGNAL(NewHostAdded(QString, QString)),availableCommandHosts, SLOT(addComboBoxItem(QString, QString)));
	connect(this, SIGNAL(OldHostRemoved(QString)), availableCommandHosts, SLOT(removeComboBoxItem(QString)));
	connect(this, SIGNAL(GameStateMsgUpdate(QString, QString, QString)), availableCommandHosts, SLOT(setLWRHGameStateInfo(QString, QString, QString)));

	connect(availableCommandHosts, SIGNAL(LWRHSubscriptionRequest(QString)), this, SLOT(SubscriptionHandler(QString)));
	connect(availableCommandHosts, SIGNAL(LWRHUnsubscriptionRequest(QString)), this, SLOT(UnsubscriptionHandler(QString)));
...
void CommandsController::setLWRHGameStateInfo(QString data1, QString data2, QString data3){
...
void CommandsController::UnsubscriptionHandler(QString data1){
