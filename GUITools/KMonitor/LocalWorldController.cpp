    ...
    ui(new Ui::LocalWorldController)
{
	...
	connect(this, SIGNAL(NewHostAdded(QString, QString)),availableLWHosts, SLOT(addComboBoxItem(QString, QString)));
	connect(this, SIGNAL(OldHostRemoved(QString)), availableLWHosts, SLOT(removeComboBoxItem(QString)));
	connect(this, SIGNAL(GameStateMsgUpdate(QString, QString, QString)), availableLWHosts, SLOT(setLWRHGameStateInfo(QString, QString, QString)));

	connect(availableLWHosts, SIGNAL(LWRHSubscriptionRequest(QString)), this, SLOT(SubscriptionHandler(QString)));
	connect(availableLWHosts, SIGNAL(LWRHUnsubscriptionRequest(QString)), this, SLOT(UnsubscriptionHandler(QString)));
...
void LocalWorldController::setLWRHGameStateInfo(QString data1, QString data2, QString data3){
...
void LocalWorldController::UnsubscriptionHandler(QString data1){
