...
void protobuf_AssignDesc_sync_2eproto() {
  ...
  SyncMessage_descriptor_ = file->message_type(0);
  static const int SyncMessage_offsets_[6] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SyncMessage, host_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SyncMessage, publisher_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SyncMessage, topic_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SyncMessage, timeout_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SyncMessage, timestamp_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SyncMessage, counter_),
  };
...
void protobuf_AddDesc_sync_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\ttimestamp\030\005 \002(\t:\000\022\017\n\007counter\030\006 \001(\005", 155);
...
const ::std::string SyncMessage::_default_host_("localhost");
const ::std::string SyncMessage::_default_publisher_;
const ::std::string SyncMessage::_default_topic_("global");
const ::std::string SyncMessage::_default_timestamp_;
#ifndef _MSC_VER
const int SyncMessage::kHostFieldNumber;
const int SyncMessage::kPublisherFieldNumber;
const int SyncMessage::kTopicFieldNumber;
const int SyncMessage::kTimeoutFieldNumber;
const int SyncMessage::kTimestampFieldNumber;
const int SyncMessage::kCounterFieldNumber;
#endif  // !_MSC_VER
