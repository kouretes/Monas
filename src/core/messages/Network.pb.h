...
class KnownHosts : public ::google::protobuf::Message {
 public:
  ...
  inline const ::HostEntry& localhost() const;
  inline ::HostEntry* mutable_localhost();
  inline ::HostEntry* release_localhost();
...
// required .HostEntry localhost = 2;
inline bool KnownHosts::has_localhost() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void KnownHosts::set_has_localhost() {
  _has_bits_[0] |= 0x00000002u;
}
inline void KnownHosts::clear_has_localhost() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void KnownHosts::clear_localhost() {
  if (localhost_ != NULL) localhost_->::HostEntry::Clear();
  clear_has_localhost();
}
inline const ::HostEntry& KnownHosts::localhost() const {
  return localhost_ != NULL ? *localhost_ : *default_instance_->localhost_;
}
inline ::HostEntry* KnownHosts::mutable_localhost() {
  set_has_localhost();
  if (localhost_ == NULL) localhost_ = new ::HostEntry;
  return localhost_;
}
inline ::HostEntry* KnownHosts::release_localhost() {
  clear_has_localhost();
  ::HostEntry* temp = localhost_;
  localhost_ = NULL;
  return temp;
}
