...
KCamView::KCamView (QWidget *parent) :
	...
	connect (availableCamHosts, SIGNAL (SubscriptionRequest (QString) ), this, SLOT (SubscriptionHandler (QString) ) );
	orangeColor = 32;
	redColor = 1;
	greenColor = 4;
	blueColor = 2;
...
void KCamView::changeToHost (QString data1) {
	availableCamHosts->changeItem (data1);
}

void KCamView::addComboBoxItem (QString data1, QString data2) {
	availableCamHosts->addComboBoxItem (data1, data2);
}

void KCamView::removeComboBoxItem (QString data1) {
	availableCamHosts->removeComboBoxItem (data1);
}

void KCamView::setGameStateInfo (QString data1, QString data2, QString data3) {
	availableCamHosts->setGameStateInfo (data1, data2, data3);
}
