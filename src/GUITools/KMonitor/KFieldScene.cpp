...
void KFieldScene::setSvgItems() {
	QString path  = ":/Posts3D/LBPost.svg";
	QString path1 = ":/Posts3D/LTPost.svg";
	QString path2 = ":/Posts3D/RTPost.svg";
	QString path3 = ":/Posts3D/RBPost.svg";
	...
	if (!path.isEmpty() && !path1.isEmpty() && !path2.isEmpty() && !path3.isEmpty() ) {
		...
		LTPost = new QGraphicsSvgItem (file1.fileName() );
		LBPost = new QGraphicsSvgItem (file.fileName() );
		RTPost = new QGraphicsSvgItem (file2.fileName() );
		RBPost = new QGraphicsSvgItem (file3.fileName() );
...
void KFieldScene::resizeFieldScene (int width, int height) {
	...
	formationLabel->move(width + 25, -15);
}
