...
void OpenChallenge2012::mglrun()
{
	...
	if(gameState == currentstate)
	{
		if(allsm != 0)
		{
			...
			fll.push_back(LHYPitch.sensorvalue());
			fll.push_back(LHRoll.sensorvalue());
			fll.push_back(LHPitch.sensorvalue());
			fll.push_back(LKPitch.sensorvalue());
			fll.push_back(LAPitch.sensorvalue());
			fll.push_back(LARoll.sensorvalue());
			FKvars output;
