...
class RobotParameters
{
	...
	public:
		RobotParameters()
		{
			...
			WalkParameters[Tds] = 0.3;// ceil(0.25 * WalkParameters[Tstep]/WalkParameters[Ts])*WalkParameters[Ts];//0.35
			WalkParameters[Tss] = 0.7; //WalkParameters[Tstep]-WalkParameters[Tds];
