...
enum
{
	StepX=0, StepY, StepZ, H0,HX,ComZ, Tstep,Tinit, Tds, Tss, Ts, MaxStepX, MaxStepY, MaxStepTheta,g,AdaptiveStepTolx,AdaptiveStepToly,ParametersSize
};
...
class RobotParameters
{
	...
	public:
		RobotParameters()
		{
			...
			WalkParameters[Tstep] = 0.36;//0.28
            WalkParameters[Tinit]= 3.00;
			WalkParameters[Tds] = ceil(0.27 * WalkParameters[Tstep]/WalkParameters[Ts])*WalkParameters[Ts];//0.35
