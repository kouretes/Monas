...
/*----------------------*/
  ...
  /* Ae(0,0)=Ad(0,0);
   ...
   Ae(3,0)=Cd(0);
   Ae(3,1)=Cd(1)*Ad(0,1);
   Ae(3,2)=Cd(0)*Ad(0,2)+Cd(2);
   Ae(3,3)=1.000;

    Be(0)=Bd(0);
    Be(1)=Bd(1);
    Be(2)=Bd(2);
    Be(3)=Cd(0)*Bd(0)+Cd(2)*Bd(2);
    Ce(0,0)=0.000;
    Ce(1,0)=0.000;
    Ce(2,0)=0.000;
    Ce(3,0)=1.000;
...
void LIPMPreviewController::LIPMComPredictor(CircularBuffer<float> & ZmpBuffer,float CoMMeasured,float ZMPMeasured)
{
	...
	unsigned int l = 0;
    //TO DO
	for (unsigned int i = 1; i < PreviewWindow; i++, l++)
	{
		if (i < ZmpBuffer.size())
  ...
  htta=Ky*ZMPReference+Kx*State_e;
  Deltau=L0.transp()*htta;
