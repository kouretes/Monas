...
namespace NEWRAN
{
	...
	inline ExtReal square(const ExtReal& x)
	{
		return x * x;
	}
	...
	{
		Throw(Bad_alloc("Newran: out of space"));
	}
...
L30:
	...
	Real NegatedRandom::Next()
	{
		return - rv->Next();
	}

	ExtReal NegatedRandom::Mean() const
	{
		return - rv->Mean();
	}

	ExtReal NegatedRandom::Variance() const
	{
		return rv->Variance();
	}

	Real ScaledRandom::Next()
	{
		return rv->Next() * s;
	}

	ExtReal ScaledRandom::Mean() const
	{
		return rv->Mean() * s;
	}

	ExtReal ScaledRandom::Variance() const
	{
		return rv->Variance() * (s * s);
	}

	Real ShiftedRandom::Next()
	{
		return rv->Next() + s;
	}

	ExtReal ShiftedRandom::Mean() const
	{
		return rv->Mean() + s;
	}

	ExtReal ShiftedRandom::Variance() const
	{
		return rv->Variance();
	}

	Real ReverseShiftedRandom::Next()
	{
		return s - rv->Next();
	}

	ExtReal ReverseShiftedRandom::Mean() const
	{
		return - rv->Mean() + s;
	}

	ExtReal ReverseShiftedRandom::Variance() const
	{
		return rv->Variance();
	}

	Real ReciprocalRandom::Next()
	{
		return s / rv->Next();
	}

	ExtReal RepeatedRandom::Mean() const
	{
		return rv->Mean() * (Real)n;
	}

	ExtReal RepeatedRandom::Variance() const
	{
		return rv->Variance() * (Real)n;
	}
	...
	ExtReal AddedRandom::Mean() const
	{
		return rv1->Mean() + rv2->Mean() ;
	}
	...
	ExtReal SubtractedRandom::Mean() const
	{
		return rv1->Mean() - rv2->Mean() ;
	}
	...
	ExtReal MultipliedRandom::Mean() const
	{
		return rv1->Mean() * rv2->Mean() ;
	}
	...
	const char* PosGen::Name()
	{
		return "PosGen";
	}
	const char* SymGen::Name()
	{
		return "SymGen";
	}
	const char* AsymGen::Name()
	{
		return "AsymGen";
	}
	const char* PosGenX::Name()
	{
		return "PosGenX";
	}
	const char* SymGenX::Name()
	{
		return "SymGenX";
	}
	const char* AsymGenX::Name()
	{
		return "AsymGenX";
	}
	...
	const char* ChiSq::Name()
	{
		return "ChiSq";
	}
	const char* Cauchy::Name()
	{
		return "Cauchy";
	}
	const char* Exponential::Name()
	{
		return "Exponential";
	}
	const char* Poisson::Name()
	{
		return "Poisson";
	}
	const char* Binomial::Name()
	{
		return "Binomial";
	}
	const char* NegativeBinomial::Name()
	{
		return "NegativeBinomial";
	}
	const char* Gamma::Name()
	{
		return "Gamma";
	}
	const char* Pareto::Name()
	{
		return "Pareto";
	}
	const char* DiscreteGen::Name()
	{
		return "DiscreteGen";
	}
	const char* SumRandom::Name()
	{
		return "SumRandom";
	}
	const char* MixedRandom::Name()
	{
		return "MixedRandom";
	}
