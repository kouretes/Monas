...
private:
	...
	struct {
		...
		unsigned int positions; // number of positions to be generated by formation generator 
	...
	std::vector< std::vector<unsigned int> > mappings;

	unsigned int numOfRobots;
	
	mutable KProfiling::profiler prf;
