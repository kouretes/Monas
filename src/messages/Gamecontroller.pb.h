...
inline ::google::protobuf::int32 GameStateMessage::player_number() const {
  return player_number_;
}
inline void GameStateMessage::set_player_number(::google::protobuf::int32 value) {
...
inline ::google::protobuf::int32 GameStateMessage::team_number() const {
  return team_number_;
}
inline void GameStateMessage::set_team_number(::google::protobuf::int32 value) {
  set_has_team_number();
  team_number_ = value;
}
