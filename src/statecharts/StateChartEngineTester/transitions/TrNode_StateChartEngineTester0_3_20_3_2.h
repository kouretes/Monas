...
// DoNothingTODoNothing
class TrCond_StateChartEngineTester0_3_20_3_2 : public statechart_engine::ICondition {		
public:
	void UserInit () {
...
// DoNothingTODoNothing
class TrAction_StateChartEngineTester0_3_20_3_2 : public statechart_engine::
				TimeoutAction {
		/* TimeoutAction.behavior.350 */
	public:	TrAction_StateChartEngineTester0_3_20_3_2() : statechart_engine::TimeoutAction( "behavior", 350 ) { 
		;
	 }
};
