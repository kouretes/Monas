...
// Stare_TO_Stare
class TrCond_GoaliePenalty0_2_2_3_6_2_20_2_2_3_6_2_2 : public statechart_engine::ICondition {		
public:
	void UserInit () {
...
&&(behavior.State.FallMessage==NULL|| behavior.State.FallMessage.fall()==0) */
		...
		Logger::Instance().WriteMsg("Stare_TO_Stare, TimeoutCheck(behavior) &&   (worldstate.State.GameStateMessage.player_state()==PLAYER_PLAYING  && !worldstate.State.GameStateMessage.kickoff() )  && behavior.State.HeadToBMessage.ballfound()>0  &&(behavior.State.FallMessage==NULL|| behavior.State.FallMessage.fall()==0)" ,_toString((msg.get()!=0 && msg->wakeup()!="" && boost::posix_time::from_iso_string(msg->wakeup())<boost::posix_time::microsec_clock::local_time()) &&   ((var_1263977940.get()!=0 && var_1263977940->player_state()==PLAYER_PLAYING)  && (var_1263977940.get()!=0 && !var_1263977940->kickoff() ))  && (var_1901744185.get()!=0 && var_1901744185->ballfound()>0)  &&(var_1561961811.get()==0 ||  (var_1561961811.get()!=0 && var_1561961811->fall()==0))),  Logger::Info);
...
// Stare_TO_Stare
class TrAction_GoaliePenalty0_2_2_3_6_2_20_2_2_3_6_2_2 : public statechart_engine::
				TimeoutAction {
		/* TimeoutAction.behavior.250 */
	public:	TrAction_GoaliePenalty0_2_2_3_6_2_20_2_2_3_6_2_2() : statechart_engine::TimeoutAction( "behavior", 250 ) { 
		;
	 }
};
