...
// Scan_TO_0.2.2.3.3.3
class TrCond_GoaliePenalty0_2_2_3_3_20_2_2_3_3_3 : public statechart_engine::ICondition {		
public:
	void UserInit () {
...
worldstate.State.GameStateMessage.kickoff()|| worldstate.State.GameStateMessage==NULL */
