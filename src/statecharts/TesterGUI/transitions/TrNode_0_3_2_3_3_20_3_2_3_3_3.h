...
// GoToPositionTO0.3.2.3.3.3
class TrCond_0_3_2_3_3_20_3_2_3_3_3 : public statechart_engine::ICondition {
...
public:
	...
	bool Eval() {
		/* behavior.State.GameStateMessage.player_state!=PLAYER_PLAYING || behavior.Signal.RobotInPosition.inposition==true */
		...
		return ( var_621149599->player_state()!=PLAYER_PLAYING || var_529308494->inposition()==true ); 
