...
class TrCond_GoalieRoboCup20120_2_4_3_20_2_4_3_4 : public statechart_engine::ICondition
{
public:
	void UserInit ()
	{
	...
	bool Eval()
	{
		...
		return ( var_1263977940.get() == 0 ||   (var_1263977940.get() != 0 && var_1263977940->previous_player_state() != PLAYER_PENALISED) || (var_969154074.get() != 0 && var_969154074->goalietopos()) );
	}
};
