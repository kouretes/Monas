...
class TrCond_GoalieRoboCup20120_2_4_3_3_20_2_4_3_3_2 : public statechart_engine::ICondition {		
public:
	void UserInit () {
 ...
 */
		...
		_blk->process_messages();
				...
				return ( (msg.get()!=0 && msg->wakeup()!="" && boost::posix_time::from_iso_string(msg->wakeup())<boost::posix_time::microsec_clock::local_time()) && (var_1263977940.get()!=0 && var_1263977940->player_state()==PLAYER_PLAYING) && !robotInPosition(var_1111221333, var_1868674971) && (var_969154074.get()!=0 && !var_969154074->goalietopos() ) );	
    }
};
...
// GoToPositionTOGoToPosition
class TrAction_GoalieRoboCup20120_2_4_3_3_20_2_4_3_3_2 : public statechart_engine::
				TimeoutAction {
		/* TimeoutAction.behavior.250 */
	public:	TrAction_GoalieRoboCup20120_2_4_3_3_20_2_4_3_3_2() : statechart_engine::TimeoutAction( "behavior", 250 ) { 
		;
	 }
};
