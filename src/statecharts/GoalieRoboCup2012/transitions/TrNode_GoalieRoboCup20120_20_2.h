...
// _open_group_NonPlaying_or_Playing_close_group_TO_open_group_NonPlaying_or_Playing_close_group_
class TrCond_GoalieRoboCup20120_20_2 : public statechart_engine::ICondition {		
public:
	void UserInit () {
...
// _open_group_NonPlaying_or_Playing_close_group_TO_open_group_NonPlaying_or_Playing_close_group_
class TrAction_GoalieRoboCup20120_20_2 : public statechart_engine::
				TimeoutAction {
		/* TimeoutAction.behavior.300 */
	public:	TrAction_GoalieRoboCup20120_20_2() : statechart_engine::TimeoutAction( "behavior", 300 ) { 
		;
	 }
};
