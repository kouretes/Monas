...
class TrCond_SearchBall_one_or_more_times_TO0_3_2_3_4_4_4 : public statechart_engine::ICondition {
...
public:
	...
	bool Eval() {
		...
		if (gsm.get()!=0 && gsm->player_state()!=PLAYER_PLAYING){
			...
			//Logger::Instance().WriteMsg("TrCond_0_3_2_3_2TOScanForBall", "FALSE NO HBM", Logger::Info);
			return false;
		}else{
