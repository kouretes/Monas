...
public:
	...
	bool Eval() {
		/* TimeoutCheck(behavior) && behavior.State.GameStateMessage.player_state()==PLAYER_PLAYING && behavior.State.HeadToBMessage.ballfound()!=0 && ballAway(behavior.Data.WorldInfo) && _behavior.Signal.FallMessage.fall()==0 */
...
class TrAction_GoalieTest0_2_3_6_2_20_2_3_6_2_2 : public statechart_engine::
	...
	public:	TrAction_GoalieTest0_2_3_6_2_20_2_3_6_2_2() : statechart_engine::TimeoutAction( "behavior", 250 ) { 
		;
	 }
};
