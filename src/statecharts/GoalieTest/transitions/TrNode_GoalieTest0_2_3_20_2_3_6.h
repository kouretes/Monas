...
// 0.2.3.2TOfollowTheBall
class TrCond_GoalieTest0_2_3_20_2_3_6 : public statechart_engine::ICondition {
...
public:
	...
	bool Eval() {
		...
		Logger::Instance().WriteMsg("var_1901744185->ballfound()!=0 && ballAway(var_1071592760)", _toString(var_1901744185->ballfound()!=0 && ballAway(var_1071592760)),  Logger::Info);
