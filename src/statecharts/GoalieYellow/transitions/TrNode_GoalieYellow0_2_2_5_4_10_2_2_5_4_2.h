...
public:
	...
	bool Eval() {
		...
		Logger::Instance().WriteMsg("0.2.2.5.4.1_TO_GoToPosition, behavior.State.LocalizeDone.moveon() " ,_toString((var_373152964.get()!=0 && var_373152964->moveon() )),  Logger::Info);
