...
behavior.State.HeadToBMessage.ballfound()==0 */
		...
		Logger::Instance().WriteMsg("0.3.2.3.2_TO_Scan_one_or_more_times_, worldstate.State.GameStateMessage==NULL ||  behavior.State.HeadToBMessage.ballfound()==0" ,_toString(var_1263977940.get()==0 ||   (var_1901744185.get()!=0 && var_1901744185->ballfound()==0)),  Logger::Info);
