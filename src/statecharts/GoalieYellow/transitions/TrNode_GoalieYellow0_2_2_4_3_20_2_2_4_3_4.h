...
public:
	...
	bool Eval() {
		...
		Logger::Instance().WriteMsg("0.3.2.4.3.2_TO_0.2.2.4.3.4, worldstate.State.GameStateMessage==NULL|| worldstate.State.GameStateMessage.player_state()!=PLAYER_READY" ,_toString(var_1263977940.get()==0 ||  (var_1263977940.get()!=0 && var_1263977940->player_state()!=PLAYER_READY)),  Logger::Info);
