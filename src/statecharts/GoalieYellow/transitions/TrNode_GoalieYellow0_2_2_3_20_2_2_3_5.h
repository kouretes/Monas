...
public:
 ...
 readyToKick(worldstate.Data.WorldInfo) */
		...
		Logger::Instance().WriteMsg("0.3.2.3.2_TO_Kick, behavior.State.HeadToBMessage.ballfound()>0 &&  readyToKick(worldstate.Data.WorldInfo)" ,_toString((var_1901744185.get()!=0 && var_1901744185->ballfound()>0) &&  readyToKick(var_1111221333)),  Logger::Info);
