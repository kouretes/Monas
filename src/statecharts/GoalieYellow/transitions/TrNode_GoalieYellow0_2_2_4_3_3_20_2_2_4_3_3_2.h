...
class TrCond_GoalieYellow0_2_2_4_3_3_20_2_2_4_3_3_2 : public statechart_engine::ICondition {		
public:
	void UserInit () {
...
&& !robotInPosition(worldstate.Data.WorldInfo, behavior.State.PositionMessage) */
		...
		Logger::Instance().WriteMsg("GoToPosition_TO_GoToPosition, TimeoutCheck(behavior)  && worldstate.State.GameStateMessage.player_state()==PLAYER_READY  && !robotInPosition(worldstate.Data.WorldInfo, behavior.State.PositionMessage)" ,_toString((msg.get()!=0 && msg->wakeup()!="" && boost::posix_time::from_iso_string(msg->wakeup())<boost::posix_time::microsec_clock::local_time())  && (var_1263977940.get()!=0 && var_1263977940->player_state()==PLAYER_READY)  && !robotInPosition(var_1111221333, var_1868674971)),  Logger::Info);
...
// GoToPosition_TO_GoToPosition
class TrAction_GoalieYellow0_2_2_4_3_3_20_2_2_4_3_3_2 : public statechart_engine::
				TimeoutAction {
		/* TimeoutAction.behavior.250 */
	public:	TrAction_GoalieYellow0_2_2_4_3_3_20_2_2_4_3_3_2() : statechart_engine::TimeoutAction( "behavior", 250 ) { 
		;
	 }
};
