...
class TrCond_ApproachBall_one_or_more_times_TO0_3_2_3_7 : public statechart_engine::ICondition {
...
public:
	...
	bool Eval() {
		Logger::Instance().WriteMsg("TrCond_ApproachBall_one_or_more_times_TO0_3_2_3_7", " ",Logger::Info);
